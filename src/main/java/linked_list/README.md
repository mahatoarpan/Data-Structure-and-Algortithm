...
## Q9. You are given the head of a linked list. Delete the middle node, and return the head of the modified linked list.

The middle node of a linked list of size n is the ⌊n / 2⌋th node from the start using 0-based indexing, where ⌊x⌋ denotes the largest integer less than or equal to x.

*leetcode - [Delete the Middle Node of a Linked List](https://leetcode.com/problems/delete-the-middle-node-of-a-linked-list/description/)*
...
**Step 2:** Traverse to the `(length / 2) - 1` the node. Previous node to the middle node.

**Step 3:** Change the link of previous.next to previous.next.next
...
**Step 1:** Assign head to two pointers - `slow` and `fast`

**Step 2:** Move fast by 2 steps

**Step 3:** Iterate over the list until `fast != null` and `fast.next != null`

**Step 4:** At each iteration, move slow by 1 step and fast by 2 steps.
